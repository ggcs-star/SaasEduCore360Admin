<!DOCTYPE html>
<?php 
$is_rtl = (isset($front_setting) && $front_setting) ? $front_setting->is_active_rtl : false;
?>
<html dir="<?php echo $is_rtl ? "rtl" : "ltr"; ?>" lang="<?php echo $is_rtl ? "ar" : "en"; ?>">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <?php 
$page_title = isset($page['title']) ? $page['title'] : 'Default Title';
$page_meta_title = isset($page['meta_title']) ? $page['meta_title'] : '';
$page_meta_keyword = isset($page['meta_keyword']) ? $page['meta_keyword'] : '';
$page_meta_description = isset($page['meta_description']) ? $page['meta_description'] : '';
?>
<title><?php echo $page_title; ?></title>
<meta name="title" content="<?php echo $page_meta_title; ?>">
...
<meta name="description" content="<?php echo $page_meta_description; ?>">
       ...
       <?php 
$fav_icon = (isset($front_setting) && $front_setting) ? $front_setting->fav_icon : 'favicon.png';
?>
<link rel="shortcut icon" href="<?php echo base_url($fav_icon); ?>" type="image/x-icon">
                            ...
                            if (in_array('news', json_decode($front_setting->sidebar_options))) {
                                ...
                                <div class="newscontent">
                                    <div class="tickercontainer"><div class="mask"><ul id="ticker01" class="newsticker" style="height: 666px; top: 124.54px;">
                                                <?php
                                                if (isset($banner_notices) && !empty($banner_notices)) {
